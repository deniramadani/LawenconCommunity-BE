...
CREATE TABLE tb_post (
	...
	ALTER TABLE tb_post_type
		ADD CONSTRAINT tb_post_type_bk UNIQUE(post_type_code);
	...
	ALTER TABLE tb_post_like
			ADD CONSTRAINT tb_post_like_pk PRIMARY KEY(id); 
		
	ALTER TABLE tb_post_like
			ADD CONSTRAINT tb_post_like_fk FOREIGN KEY(post_id)
			REFERENCES tb_post(id);
		
	ALTER TABLE tb_post_like
			ADD CONSTRAINT tb_post_like_user_fk FOREIGN KEY(user_id)
	...
	ALTER TABLE tb_post_bookmark
			ADD CONSTRAINT tb_post_bookmark_pk PRIMARY KEY(id); 
		
	ALTER TABLE tb_post_bookmark
			ADD CONSTRAINT tb_post_bookmark_fk FOREIGN KEY(post_id)
			REFERENCES tb_post(id);
		
	ALTER TABLE tb_post_bookmark
			ADD CONSTRAINT tb_post_bookmark_user_fk FOREIGN KEY(user_id)
			REFERENCES tb_user(id);
	...
	ALTER TABLE tb_post_polling
			ADD CONSTRAINT tb_post_polling_pk PRIMARY KEY(id); 
		
	ALTER TABLE tb_post_polling
			ADD CONSTRAINT tb_post_polling_fk FOREIGN KEY(post_id)
			REFERENCES tb_post(id);
	...
	ALTER TABLE tb_post_polling_option
			ADD CONSTRAINT tb_post_polling_pk PRIMARY KEY(id); 
